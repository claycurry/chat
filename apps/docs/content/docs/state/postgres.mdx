---
title: PostgreSQL
description: Production state adapter using postgres and drizzle-orm.
type: reference
prerequisites:
  - /docs/getting-started
---

Production PostgreSQL state adapter built with [postgres](https://www.npmjs.com/package/postgres) and [drizzle-orm](https://www.npmjs.com/package/drizzle-orm). Use this when PostgreSQL is your primary datastore and you want state persistence without a separate Redis dependency.
...
| `client` | No | Existing `postgres` client |
