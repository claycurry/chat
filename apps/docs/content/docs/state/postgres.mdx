---
title: PostgreSQL
description: Production state adapter using postgres.
type: reference
prerequisites:
  - /docs/getting-started
---

Production PostgreSQL state adapter built with [postgres](https://www.npmjs.com/package/postgres). Use this when PostgreSQL is your primary datastore and you want state persistence without a separate Redis dependency.
