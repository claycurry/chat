...
PostgreSQL state adapter for [Chat SDK](https://chat-sdk.dev/docs) using [postgres](https://www.npmjs.com/package/postgres) and [drizzle-orm](https://www.npmjs.com/package/drizzle-orm). Suitable for production when PostgreSQL is your primary data store.
